Ext.define('WmsMobile.controller.Enderecamento', {
    ...
    // enderecamentoLancarView_enderecoTextField_onChange:function(sender, newValue, oldValue, eOpts){
    //     this.validaEndereco(sender, newValue);
    // },
    ...
    enderecamentoLancarView_botaoConfirmar_onConfirmarenderecamentoLancarView: function(button, e) {
        ...
        var endereco = cm.getCtrl('enderecoTextField');
