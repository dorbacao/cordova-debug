...
Ext.define('Exception',{
    ...
    NotImplementedException:"MÃ©todo ainda nÃ£o foi implementado",
    InvalidArgumentException:"O valor informado no parÃ¢metro Ã© de um tipo invÃ¡lido",
    ArgumentNullException:"O valor informado no parÃ¢metro Ã© invÃ¡lido",
...
Ext.application({
    ...
    models:[
        ...
        'UsuarioPossuiPermissaoEndereco'
    ],
    ...
    launch: function() {
        ...
        Ext.apply(Ext.util.Format, {
            naoInformado: function(value) {
                return value !== undefined && value != null && value != '' ? value : 'NÃ£o Informado';
            },
            naoControla: function(value) {
                return value !== undefined && value != null && value != '' ? value : 'NÃ£o Controla';
            },
        });
