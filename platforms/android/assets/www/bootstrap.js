...
Ext.Loader.addClassPathMappings({
  "Enums.StatusDocumento": "app.js",
  "Enums.TipoDeLancamento": "app.js",
  "Enums.TipoEndereco": "app.js",
  "Exception": "app.js",
  "Ext": "touch/src",
  ...
  "StackRouter": "app.js",
  "WmsMobile": "app",
  "WmsMobile.view.inventario.ListarEstoques": "app/view/abastecimento/ListaEstoques.js"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "WmsMobile.controller.Abastecimento": [],
  "WmsMobile.controller.ControllerBase": [],
  "WmsMobile.controller.Enderecamento": [],
  "WmsMobile.controller.Expedicao": [],
  "WmsMobile.controller.Inventario": [],
  "WmsMobile.controller.Main": [],
  "WmsMobile.controller.Movimentacao": [],
  "WmsMobile.controller.Recebimento": [],
  "WmsMobile.controller.Separacao": [],
  ...
  "WmsMobile.model.LancamentoAbastecimento": [],
  "WmsMobile.model.LancamentoEnderecamento": [],
  "WmsMobile.model.LancamentoExpedicao": [],
  ...
  "WmsMobile.model.LancamentoRecebimento": [],
  "WmsMobile.model.LancamentoSeparacao": [],
  "WmsMobile.model.ListItem": [],
  "WmsMobile.model.Log": [],
  "WmsMobile.model.Menu": [],
  "WmsMobile.model.ModelBase": [],
  ...
  "WmsMobile.model.StackRouter": [],
  "WmsMobile.model.StatusDocumento": [],
  "WmsMobile.model.Usuario": [],
  "WmsMobile.model.UsuarioPossuiPermissaoArea": [],
  "WmsMobile.model.UsuarioPossuiPermissaoEndereco": [],
  "WmsMobile.store.Abastecimento": [],
  "WmsMobile.store.AbastecimentoFinalizado": [],
  "WmsMobile.store.Avaria": [],
  "WmsMobile.store.Carrinho": [],
  "WmsMobile.store.Documento": [],
  "WmsMobile.store.DocumentoFinalizado": [],
  "WmsMobile.store.Endereco": [],
  "WmsMobile.store.EnderecoAbastecimento": [],
  "WmsMobile.store.EnderecoInventario": [],
  "WmsMobile.store.Inventario": [],
  "WmsMobile.store.InventarioPorEndereco": [],
  "WmsMobile.store.InventarioPorProduto": [],
  "WmsMobile.store.ItemDocumento": [],
  "WmsMobile.store.Lancamento": [],
  "WmsMobile.store.LancamentoInventario": [],
  "WmsMobile.store.Log": [],
  "WmsMobile.store.Movimentacao": [],
  "WmsMobile.store.PosicaoEstoque": [],
  "WmsMobile.store.Produto": [],
  "WmsMobile.store.TreeMenu": [],
  "WmsMobile.store.Usuario": [],
  "WmsMobile.view.Erro": [],
  "WmsMobile.view.LancarBase": [],
  "WmsMobile.view.Login": [],
  "WmsMobile.view.Main": [],
  "WmsMobile.view.Viewport": [],
  ...
  "WmsMobile.view.inventario.ListarEstoques": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "WmsMobile.view.abastecimento.Lancar": [
    "widget.abastecimentoLancarView"
  ],
  "WmsMobile.view.abastecimento.ListarEndereco": [
    "widget.abastecimentoListarEnderecoView"
  ],
  "WmsMobile.view.abastecimento.ListarEnderecosOrigem": [
    "widget.abastecimentoListarEnderecosOrigemView"
  ],
  "WmsMobile.view.abastecimento.ListarEnderecosPicking": [
    "widget.abastecimentoListarEnderecosPickingView"
  ],
  "WmsMobile.view.abastecimento.ListarItemDocumento": [
    "widget.abastecimentoListarItemDocumentoView"
  ],
  "WmsMobile.view.abastecimento.ListarPosicaoEstoque": [
    "widget.abastecimentoListarPosicaoEstoqueView"
  ],
  "WmsMobile.view.abastecimento.ListarProdutos": [
    "widget.abastecimentoListarProdutosView"
  ],
  "WmsMobile.view.enderecamento.Lancar": [
    "widget.enderecamentoLancarView"
  ],
  "WmsMobile.view.enderecamento.ListarDocumento": [
    "widget.enderecamentoListarView"
  ],
  "WmsMobile.view.enderecamento.ListarItemDocumento": [
    "widget.enderecamentoListarItemDocumentoView"
  ],
  "WmsMobile.view.expedicao.ImpressaoEtiqueta": [
    "widget.expedicaoImpressaoEtiqueta"
  ],
  "WmsMobile.view.expedicao.Lancar": [
    "widget.expedicaoLancarView"
  ],
  "WmsMobile.view.expedicao.ListarDocumento": [
    "widget.expedicaoListarView"
  ],
  "WmsMobile.view.expedicao.ListarItemDocumento": [
    "widget.expedicaoListarItemDocumentoView"
  ],
  "WmsMobile.view.inventario.LancarInventarioEndereco": [
    "widget.inventarioLancarInventarioEnderecoView"
  ],
  "WmsMobile.view.inventario.LancarInventarioProduto": [
    "widget.inventarioLancarInventarioProdutoView"
  ],
  "WmsMobile.view.inventario.ListarEnderecos": [
    "widget.inventarioListarEnderecosView"
  ],
  "WmsMobile.view.inventario.ListarEstoques": [
    "widget.inventarioListarEstoquesView"
  ],
  "WmsMobile.view.inventario.ListarLancamentos": [
    "widget.inventarioListarLancamentosView"
  ],
  "WmsMobile.view.inventario.ListarPlanejadosPorEndereco": [
    "widget.inventarioListarPlanejadosPorEnderecoView"
  ],
  "WmsMobile.view.inventario.ListarPlanejadosPorProduto": [
    "widget.inventarioListarPlanejadosPorProdutoView"
  ],
  "WmsMobile.view.inventario.ListarProdutos": [
    "widget.inventarioListarProdutosView"
  ],
  "WmsMobile.view.movimentacao.ListarDestino": [
    "widget.movimentacaoListarDestinoView"
  ],
  "WmsMobile.view.movimentacao.ListarOrigem": [
    "widget.movimentacaoListarOrigemView"
  ],
  "WmsMobile.view.movimentacao.ListarProdutos": [
    "widget.movimentacaoListarProdutosView"
  ],
  "WmsMobile.view.recebimento.Lancar": [
    "widget.recebimentoLancarView"
  ],
  "WmsMobile.view.recebimento.ListarDocumento": [
    "widget.recebimentoListarView"
  ],
  "WmsMobile.view.recebimento.ListarItemDocumento": [
    "widget.recebimentoListarItemDocumentoView"
  ],
  "WmsMobile.view.separacao.Lancar": [
    "widget.separacaoLancarView"
  ],
  "WmsMobile.view.separacao.ListarCarrinho": [
    "widget.separacaoListarCarrinhoView"
  ],
  "WmsMobile.view.separacao.ListarDocumento": [
    "widget.separacaoListarView"
  ],
  "WmsMobile.view.separacao.ListarItemDocumento": [
    "widget.separacaoListarItemDocumentoView"
  ]
});
